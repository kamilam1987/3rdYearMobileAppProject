...
namespace myCollegeApp
{
    public class Library
    {
        ...
        public void New(DatePicker startDate, TimePicker startTime, TextBox module, TextBox location, TextBox details, ComboBox duration, CheckBox allDay)
        {
        ...
        public async void Add(object sender, DatePicker startDate, TimePicker startTime, TextBox module, TextBox location, TextBox details, ComboBox duration, CheckBox allDay)
        {
